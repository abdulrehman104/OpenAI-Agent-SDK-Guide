...
escalation_agent = Agent(
    ...
    instructions=(
        "You handle complex or sensitive customer issues that require "
...
# ———— Define the Service Agent (orchestrator) with input_filter ————————————————————————————————
service_agent = Agent(
    name="Service Agent",
    instructions=(
        "You are a customer service agent who handles general inquiries.\n\n"
...
async def main():
    prompt = """
    A customer has a billing issue that requires special attention. Please escalate this to the Escalation Agent with the following details:

    - Reason: Billing dispute
    - Priority: Urgent
    - Customer tier: Premium
    """
    result = await Runner.run(service_agent, prompt)
